...
import { SpecError, type EnrichmentChain, type HuntSpec } from "./spec.js";
...
// exposure is not destruction but a value choosing what the enrichment returns —
// telemetry steering the hunt.
//
// A single-quoted SQL literal terminates only on a quote, so doubling it is the
// whole escape. Double quotes and backticks are refused outright rather than
// escaped, because no real observable carries one and a chain is free to quote
// its placeholder as an identifier instead.
