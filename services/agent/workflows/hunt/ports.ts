...
export interface DecisionProvider {
  // The signal is the operator's abort, not the lease's. Optional because a
  // scripted provider has nothing to cancel; a real one must pass it on, or an
  // abort queued during a lead call waits out the whole call before it lands.
