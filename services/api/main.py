...
def _mcp_auto_connect_enabled() -> bool:
    ...
    # trust its warm-start cache, and the two disagreeing is how a capability binds
    # to a server this boot never dialled.
...
async def _connect_external_services(mcp_client, registry):
    ...
    if not _mcp_auto_connect_enabled():
        ...
        # and what authorises the call behind it, and call_tool reconnects itself.
